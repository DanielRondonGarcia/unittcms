...
export default function Page({ params }: { params: { projectId: string; folderId: string; locale: string } }) {
  ...
  const messages = {
    ...
    reorderGuidance: t('reorder_guidance'),
    reorderDisabledFiltered: t('reorder_disabled_filtered'),
    reorderDisabledSort: t('reorder_disabled_sort'),
    reorderDisabledPermission: t('reorder_disabled_permission'),
    reorderSaving: t('reorder_saving'),
    reorderSaveError: t('reorder_save_error'),
    moveCaseUp: t('move_case_up'),
    moveCaseDown: t('move_case_down'),
