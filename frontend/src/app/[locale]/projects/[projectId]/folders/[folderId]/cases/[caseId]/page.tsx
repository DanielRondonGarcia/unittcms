...
export default function Page({
  ...
  const messages = {
    ...
    selectAutomationEnvironment: t('select_automation_environment'),
    noAutomationEnvironments: t('no_automation_environments'),
    runAutomatically: t('run_automatically'),
    ...
    automationSummary: t('automation_summary'),
    automationErrorDetail: t('automation_error_detail'),
    automationDuration: t('automation_duration'),
    automationEvidence: t('automation_evidence'),
    automationHistory: t('automation_history'),
    cancelAutomation: t('cancel_automation'),
    downloadAutomationArtifact: t('download_automation_artifact'),
    automationUnavailable: t('automation_unavailable'),
    automationNoEvidence: t('automation_no_evidence'),
  };
