...
export default function RunLayout({
  ...
  const messages: RunMessages = {
    ...
    automationTechnicalFailure: t('automation_technical_failure'),
    automationFunctionalFailure: t('automation_functional_failure'),
    automationEvidenceFailure: t('automation_evidence_failure'),
    automationCancelledDetail: t('automation_cancelled_detail'),
    automationGenericFailure: t('automation_generic_failure'),
    automationTimeoutDetail: t('automation_timeout_detail'),
